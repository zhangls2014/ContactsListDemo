...
/**
 * Created by zhangls on 2016/10/18.
 *
...
public class TitleItemDecoration extends RecyclerView.ItemDecoration {
     ...
     * 数据源
     */
    private List<? extends NameBean> mData;
    /**
     * Title绘制的画笔
     */
     ...
     * Title字体颜色
     */
    private int COLOR_TITLE_FONT = Color.parseColor("#FF999999");

    public TitleItemDecoration(Context context, List<? extends NameBean> data) {
        super();
        mData = data;
        mPaint = new Paint();
        mBounds = new Rect();
     ...
     * 设置Title背景颜色
     *
     * @param colorTitleBg Title背景颜色
     */
    public void setColorTitleBg(int colorTitleBg) {
     ...
     * 设置Title字体颜色
     *
     * @param colorTitleFont 字体颜色
     */
    public void setColorTitleFont(int colorTitleFont) {
        this.COLOR_TITLE_FONT = colorTitleFont;
    }

    /**
     * 设置Title字体大小
     *
     * @param mTitleFontSize Title字体大小
     */
    public void setTitleFontSize(int mTitleFontSize) {
        mPaint.setTextSize(mTitleFontSize);
    }
     ...
     * @param mData 数据源
     */
    public void setData(List<? extends NameBean> mData) {
        this.mData = mData;
    }
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (position > -1) {
                if (position == 0) {//等于0肯定要有title的
                    ...
                    if (mData.get(position).getTag() != null
    ...
    private void drawTitleArea(Canvas c, int left, int right, View child,
        ...
        System.out.println("===" + child.getPaddingLeft() + "===");
    ...
    public void onDrawOver(Canvas c, final RecyclerView parent, RecyclerView.State state) {//最后调用 绘制在最上层
        ...
        if (mData == null || mData.isEmpty() || pos > mData.size() - 1) {//pos为1，size为1，1>0? true
            return;//越界
        }
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (mData == null || mData.isEmpty() || position > mData.size() - 1) {//pos为1，size为1，1>0? true
            return;//越界
        }
        //我记得Rv的item position在重置时可能为-1.保险点判断一下吧
        if (position > -1) {
